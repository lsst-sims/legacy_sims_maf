...
class TestDriver(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.outputFiles= [['OpsimTest_CoaddM5__g_and_night_lt_15_HEAL.npz',
                            'OpsimTest_CoaddM5__g_and_night_lt_15_HEAL_Histogram.pdf',
                            'OpsimTest_CoaddM5__g_and_night_lt_15_HEAL_PowerSpectrum.pdf',
                            'OpsimTest_CoaddM5__g_and_night_lt_15_HEAL_SkyMap.pdf',
                            'OpsimTest_CoaddM5__g_and_night_lt_15_OPSI.npz',
                            'OpsimTest_CoaddM5__g_and_night_lt_15_OPSI_Histogram.pdf',
                            'OpsimTest_CoaddM5__g_and_night_lt_15_OPSI_SkyMap.pdf',
                            'OpsimTest_CoaddM5__g_and_night_lt_15dith_HEAL.npz',
                            'OpsimTest_CoaddM5__g_and_night_lt_15dith_HEAL_Histogram.pdf',
                            'OpsimTest_CoaddM5__g_and_night_lt_15dith_HEAL_PowerSpectrum.pdf',
                            'OpsimTest_CoaddM5__g_and_night_lt_15dith_HEAL_SkyMap.pdf',
                            'OpsimTest_CoaddM5__r_and_night_lt_15_HEAL.npz',
                            'OpsimTest_CoaddM5__r_and_night_lt_15_HEAL_Histogram.pdf',
                            'OpsimTest_CoaddM5__r_and_night_lt_15_HEAL_PowerSpectrum.pdf',
                            'OpsimTest_CoaddM5__r_and_night_lt_15_HEAL_SkyMap.pdf',
                            'OpsimTest_CoaddM5__r_and_night_lt_15_OPSI.npz',
                            'OpsimTest_CoaddM5__r_and_night_lt_15_OPSI_Histogram.pdf',
                            'OpsimTest_CoaddM5__r_and_night_lt_15_OPSI_SkyMap.pdf',
                            'OpsimTest_CoaddM5__r_and_night_lt_15dith_HEAL.npz',
                            'OpsimTest_CoaddM5__r_and_night_lt_15dith_HEAL_Histogram.pdf',
                            'OpsimTest_CoaddM5__r_and_night_lt_15dith_HEAL_PowerSpectrum.pdf',
                            'OpsimTest_CoaddM5__r_and_night_lt_15dith_HEAL_SkyMap.pdf',
                            ...
                            'OpsimTest_Count_fiveSigmaDepth__g_ONED.npz',
                            'OpsimTest_Count_fiveSigmaDepth__g_ONED_BinnedData.pdf',
                            'OpsimTest_Count_fiveSigmaDepth__r_ONED.npz',
                            'OpsimTest_Count_fiveSigmaDepth__r_ONED_BinnedData.pdf',
                            'OpsimTest__OpsimTest_Count_fiveSigmaDepth_ONED_hist.pdf',
                            'ResultsSummary.dat',
                            'configDetails.txt',
                            'configSummary.txt',
