...
class BaseStacker(object):
    ...
    def __init__(self):
        ...
        """
        # Names of the columns generated by the Stacker.
        self.colsAdded = None
        # Names of the columns required from the database (to generate the Stacker columns).
        self.colsReq = None
        # Optional: provide units for the columns defined in colsAdded.
        self.units = None
        
    def _opsimStack(self, simData):
        """
        Merge self.stackerCols (a list of numpy structured arrays or a single structured array (which could have multiple columns) 
          into the simData array. Checks if new columns are present in the existing simData array and replaces these if so.
        Returns the merged result.
        """
        # Check on names.
        return rfn.merge_arrays((simData, self.stackerCols), flatten=True, usemask=False)
    ...
    def run(self, simData):
        ...
        """
        # Example of creating a stackerCols array for addition to the simdata array.
        self.stackerCols = None 
