...
class CompletenessMetric(ComplexMetric):
    ...
    def __init__(self, filterColName='filter', u=0, g=0, r=0, i=0, z=0, y=0, **kwargs):
        ...
        super(CompletenessMetric,self).__init__(self.filterCol, **kwargs)
    ...
    def run(self, dataSlice):
        ...
        allCompleteness.append(np.min(allCompleteness))
