...
def configureSlicer(name, kwargs={}, metricDict=None, constraints=[''], stackerDict=None, mapsDict=None, plotConfigs=None, metadata=''):
    """
...
def readSlicerConfig(config):
    ...
    return name, kwargs, metricDict, constraints, stackerDict, mapsDict, plotConfigs, metadata
