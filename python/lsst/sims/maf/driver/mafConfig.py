...
class MafConfig(pexConfig.Config):
    ...
    dbAddress = pexConfig.DictField("Database access", keytype=str, itemtype=str, default={'dbAddress':'','OutputTable':'Output','fieldTable':'',  'sessionID':'' , 'proposalTable':'' , 'proposalID':'' })
