...
def mafConfig(config, runName, dbDir='.', outputDir='Out', binnerName='OpsimFieldBinner', **kwargs):
    ...
    for f in filters:
        ...
        binner = configureBinner(binnerName, kwargs=binnerkwargs, metricDict=metricDict,
    ...
    binner = configureBinner('OneDBinner', kwargs={"sliceDataColName":'slewTime'},
    ...
    binner = configureBinner('OpsimFieldBinner', metricDict=metricDict,
    ...
    for f in filters:
        ...
        binner = configureBinner('UniBinner', metricDict=metricDict, constraints=['filter = "%s"'%f])
        binList.append(binner)
    ...
    binner = configureBinner('UniBinner', metricDict=metricDict, constraints=[''])
    binList.append(binner)
    ...
    binner = configureBinner('UniBinner', metricDict=makeDict(m1),
    ...
    binner = configureBinner('OneDBinner', kwargs={'sliceDataColName':'night'},
    ...
    m1 = configureMetric('CountMetric', params=['expMJD'],
                          ...
                          summaryStats={'f0Area':{'nside':f0nside},
                                        'f0Nv':{'nside':f0nside}})
    binner = configureBinner('f0Binner', kwargs={"nside":f0nside},
                              metricDict=makeDict(m1),
    ...
    for f in filters:
        ...
        binner = configureBinner('OneDBinner', kwargs={"sliceDataColName":'fivesigma_modified'},
