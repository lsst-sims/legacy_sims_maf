...
than a threshhold number of visits occured within some larger time
interval of number of nights, the number of lunations that received
more than a threshhold number of nights with multiple visits, and
the number of successive lunations that received more than a
threshhold number of nights with multiple visits. The reduce methods
...
desireable; however, the first step is somewhat computationally
